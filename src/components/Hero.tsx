  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-secondary/15 rounded-full blur-[120px] animate-pulse-glow" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-accent/10 rounded-full blur-[80px] animate-pulse-glow" style={{ animationDelay: '1s' }}></div>
      </div>

      {/* Floating particles */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-[10%] w-2 h-2 bg-primary rounded-full animate-float"></div>
        <div className="absolute top-40 right-[15%] w-3 h-3 bg-secondary rounded-full animate-float" style={{ animationDelay: '1s', animationDuration: '8s' }}></div>
        <div className="absolute bottom-32 left-[20%] w-2 h-2 bg-accent rounded-full animate-float" style={{ animationDelay: '2s', animationDuration: '7s' }}></div>
        <div className="absolute bottom-48 right-[25%] w-1.5 h-1.5 bg-primary rounded-full animate-float" style={{ animationDelay: '0.5s', animationDuration: '9s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-3 opacity-60">
            {['Python', 'TensorFlow', 'React', 'JavaScript', 'Machine Learning'].map((tech, i) => (
              <div 
                key={tech} 
                className="glass-effect px-4 py-2 rounded-full text-xs md:text-sm font-medium hover:opacity-100 transition-opacity"
